...
public class StartByMessage {
	...
	public static void main(String[] args) {
		...
		// 部署流程描述文件 mark 事件描述表就会有这个消息事件数据
		...
		runtimeService.startProcessInstanceByMessage(messageName, "testKey");
		runtimeService.startProcessInstanceByMessage(messageName, "testKey2", vars);
		// 查询流程实例，结果为4
